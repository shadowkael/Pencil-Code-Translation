...
<div align="center">
    <p><img alt="01" src="./image/2/01.png"></p>
...
<div align="center">
    <p><img alt="02" src="./image/2/02.png"></p>
...
<div align="center">
    <p><img alt="03" src="./image/2/03.png"></p>
...
<div align="center">
    <p><img alt="04" src="./image/2/04.png"></p>
...
<div align="center">
    <p><img alt="05" src="./image/2/05.png"></p>
...
<div align="center">
    <p><img alt="06" src="./image/2/06.png"></p>
...
<div align="center">
    <p><img alt="07" src="./image/2/07.png"></p>
...
<div align="center">
    <p><img alt="08" src="./image/2/08.png"></p>
...
<div align="center">
    <p><img alt="09" src="./image/2/09.png"></p>
...
<div align="center">
    <p><img alt="10" src="./image/2/10.png"></p>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>
                <p><u>代码：</u></p>
                <p><img alt="11" src="./image/2/11.png"></p>
                <hr />
                <p><u>代码：</u></p>
                <p><img alt="12" src="./image/2/12.png"></p>
                <hr />
                <p><u>代码：</u></p>
                <p><img alt="13" src="./image/2/13.png"></p>
            </td>
            <td>
                <p>示例：</p>
                <p>直线，</p>
                <p><u>输出：</u></p>
                <p><img alt="14" src="./image/2/14.png"></p>
                <p>方形</p>
                 <p><u>输出：</u></p>
                <p><img alt="15" src="./image/2/15.png"></p>
                <p>和三角形（移动块）。</p>
                 <p><u>输出：</u></p>
                <p><img alt="16" src="./image/2/16.png"></p>
...
<table>
    ...
    <tbody>
        <tr>
            <td>
                <p><u>代码：</u></p>
                <p><img alt="17" src="./image/2/17.png"></p>
                <p><u>代码：</u></p>
                <p><img alt="18" src="./image/2/18.png"></p>
            </td>
            <td>
                <p>对<u>Dot Row</u>和<u>Smiley</u>（艺术块）的演示展示了速度块的作用</p>
                <p><u>输出：</u></p>
                <p><img alt="19" src="./image/2/19.png"></p>
                 <p><u>输出：</u></p>
                <p><img alt="20" src="./image/2/20.png"></p>
        ...
        <tr>
            <td>
            <p><img alt="21" src="./image/2/21.png"></p>
            </td>
            <td>
            <p>学生们要想办法创建一个眼睛部件。</p>
            <p>以下是代码（答案）</p>
            <p><img alt="22" src="./image/2/22.png"></p>
            <p>提示：</p>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>
                <p><u>代码：</u></p>
                <p><img alt="23" src="./image/2/23.png"></p>
                <p><u>输出：</u></p>
                <p><img alt="24" src="./image/2/24.png"></p>
            </td>
            <td>
                <p>演示小乌龟程序。</p>
...
<table>
    ...
    <tbody>
        <tr>
            <td>
                <p><u>代码（文本模式）：</u></p>
                <p><img alt="25" src="./image/2/25.png"></p>
                <p><u>块模式：</u></p>
                <p><img alt="26" src="./image/2/26.png"></p>
            </td>
            <td>
                ...
                <p>现在让同学们来创建他们自己的贴图。</p>
                <p><u>输出：</u></p>
                <p><img alt="27" src="./image/2/27.png"></p>
            </td>
            <td>
            <p>演示时间：15分钟</p>
            <p>练习时间：30分钟</p>
